...
class Holded
{
    ...
    public function __construct(string $apiKey, ?string $url = null)
    {
        $this->httpClient = new Client(HttpClient::create(), $apiKey, $url);
    ...
    {
        return $this->ordersClient->updateInvoice($order);
    }
    ...
    {
        if (empty($shop->shopName) || empty($shop->shopUrl)) {
            return false;
        }
