...
//                    }else{
                        $id_cms = Tools::getValue('val_identifier');
//                    }
                    $page = '';
                    if($db_table != '')
                        
                    //    var_dump(Tools::getValue('val_identifier'));die();
                    $page = JsComposer::getJsControllerValues($db_table,$field_content,$field_identifier,$id_cms,$id_lang);
