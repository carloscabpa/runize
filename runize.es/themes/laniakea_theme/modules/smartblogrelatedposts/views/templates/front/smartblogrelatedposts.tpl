...
<div id="articleRelated">
    <h4 class="title_block">{l s="Related"  mod="smartblog"} <span>{l s="News"  mod="smartblog"}</span></h4>
            ...
            {foreach from=$posts item="post"}
                ...
                <div class="item post-item">
                    <div class="post-image">
                         <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}"><img alt="{$post.meta_title}" class="feat_img_small img-fluid" src="{$modules_dir}smartblog/images/{$post.id_smart_blog_post}-home-default.jpg"></a>
                    </div>
