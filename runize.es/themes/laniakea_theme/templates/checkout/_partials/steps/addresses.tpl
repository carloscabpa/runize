    ...
    >
      ...
      *}
      ...
      {elseif $customer.addresses|count > 0}
        ...
        <p class="add-address">
          <a href="{$new_address_delivery_url}"><span>{l s='add new address' d='Shop.Theme.Actions'}</span></a>
        </p>
      ...
      {if !$use_same_address}
        ...
        <h2 class="h4 mb-25">{l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h2>
        ...
        {else}
          ...
          <p class="add-address">
            <a href="{$new_address_invoice_url}"><span>{l s='add new address' d='Shop.Theme.Actions'}</span></a>
          </p>
        {/if}
      ...
      {/if}
      {if $use_same_address && !$cart.is_virtual}
        <p class="mt-20 different-invoice-address">
