    ...
    <div class="header-top hidden-sm-down header-color-1">
        <div class="container">
            <div class="row align-items-center no-gutters">
                ...
                <div class="col-md-8 d-flex align-items-center justify-content-end header-top-right">
                    <div id="_desktop_advancsearch">{hook h='displayAdvanceSearch'}</div>
                    <div id="block_myaccount_infos" class="myaccount_infos groups-selector hidden-sm-down dropdown">
                        <div class="myaccount-title dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"" id="_desktop_user_info">
                            <i class="novicon_accountblock black"></i><span>{l s='setting' d='Shop.Theme.Customeraccount'}</span>
                        </div>
                    ...
                    <div class="link_wishlist">
                        <a href="{$link->getModuleLink('novblockwishlist', 'mywishlist', array(), true)|escape:'html':'UTF-8'}" title="{l s='My Wishlists' mod='novblockwishlist'}">
                            <i class="novicon_wishlist black"></i><span>{l s='wishlist' d='Shop.Theme.Customeraccount'}</span>
                        </a>
                    </div>
