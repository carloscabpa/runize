  ...
  <form id="order-return-form" action="{$urls.pages.order_follow}" method="post">
              ...
              {if $product.customizations}
                {foreach from=$product.customizations item="customization"}
                  ...
                  <div id="_desktop_product_customization_modal_wrapper_{$customization.id_customization}">
                    <div class="modal fade customization-modal" id="product-customizations-modal-{$customization.id_customization}" tabindex="-1" role="dialog">
    ...
    <div class="box">
      ...
      <footer class="form-footer">
        ...
        <button class="form-control-submit btn btn-primary mb-20" type="submit" name="submitReturnMerchandise">
