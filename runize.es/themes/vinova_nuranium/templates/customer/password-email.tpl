  ...
  <form action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <section class="form-fields mt-20">
      <div class="form-group center-email-fields mb-10">
        <label class="col-md-3 form-control-label required p-0 mb-30 text-center"><b>{l s='Email address' d='Shop.Forms.Labels'}</b></label>
        ...
        <button class="form-control-submit btn btn-primary col-md-5" name="submit" type="submit">
...
{block name='page_footer'}
  <a href="{$urls.pages.my_account}" class="account-link d-flex align-items-center justify-content-center col-md-5">
