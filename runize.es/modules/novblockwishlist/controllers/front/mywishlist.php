...
class NovBlockWishListMyWishListModuleFrontController extends ModuleFrontController
{
	...
	public function assign()
	{
		...
		$wishlist = WishList::getByIdCustomer($this->context->customer->id);
		if($wishlist && count($wishlist) > 0) {
			$this->context->smarty->assign(array('token_wish' => $wishlist['0']['token']));
		} else {
			$this->context->smarty->assign(array('token_wish' => ''));
		}
