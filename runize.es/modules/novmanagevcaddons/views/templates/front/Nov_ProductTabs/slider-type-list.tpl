...
<div class="nov-producttabs tab-slider tab-style-{$tabs_style}">
	<div class="block-producttabs clearfix">
				...
				{foreach from=$tabs item=tab_item name=tabcontent}
					...
					<div class="tab-pane fade active" id="newproducts{$tab}" role="tabpanel">
						{if !empty($newproducts)}
							<div class="nov-productslick row product_list grid slick-slider" data-rows="{$number_row}" data-xl="{$xl}" data-lg="{$lg}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
								{include file="$nov_dir./templates/_partials/layout/items/item_list.tpl" products=$newproducts class_item='pl-15 pr-15'}
							</div>
						{else}
					...
					<div class="tab-pane fade" id="bestsellers{$tab}" role="tabpanel">
						{if !empty($bestsellersproducts)}
							<div class="nov-productslick row product_list grid slick-slider" data-rows="{$number_row}" data-xl="{$xl}" data-lg="{$lg}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
								{include file="$nov_dir./templates/_partials/layout/items/item_list.tpl" products=$bestsellersproducts class_item='pl-15 pr-15'}
							</div>
						{else}
							<p class="alert alert-info">{l s='No products at this time.' mod='novmanagevcaddons'}</p>
						{/if}
					...
					<div class="tab-pane fade" id="specialproducts{$tab}" role="tabpanel">
						{if !empty($specialproducts)}
							<div class="nov-productslick row product_list grid slick-slider" data-rows="{$number_row}" data-xl="{$xl}" data-lg="{$lg}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
								{include file="$nov_dir./templates/_partials/layout/items/item_list.tpl" products=$specialproducts class_item='pl-15 pr-15'}
							</div>
						{else}
							<p class="alert alert-info">{l s='No products at this time.' mod='novmanagevcaddons'}</p>
						{/if}
					...
					<div class="tab-pane fade" id="featureproducts{$tab}" role="tabpanel">
						{if !empty($featureproducts)}
							<div class="nov-productslick row product_list grid slick-slider" data-rows="{$number_row}" data-xl="{$xl}" data-lg="{$lg}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
								{include file="$nov_dir./templates/_partials/layout/items/item_list.tpl" products=$featureproducts class_item='pl-15 pr-15'}
							</div>
						{else}
							<p class="alert alert-info">{l s='No products at this time.' mod='novmanagevcaddons'}</p>
						{/if}
		...
		{if !empty($view_all)}
			<div class="view_all text-center"><a href="{$view_all}">{$text_view_all}</a></div>
		{/if}
	</div>
</div>