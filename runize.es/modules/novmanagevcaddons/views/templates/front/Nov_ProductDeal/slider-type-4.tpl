...
{if isset($products)}
    <div class="nov-productdeals type-slider-4{if isset($el_class) && $el_class} {$el_class}{/if}">
                ...
                <div class="nov-productslick product_list grid slick-slider row" data-rows="{$number_row}" data-xl="{$xl}" data-lg="{$lg}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
                    {foreach from=$products item=product name=products}
                        <div class="item pl-15 pr-15 pl-xs-5 pr-xs-5">
                            <div class="product-miniature js-product-miniature item-four {if $smarty.foreach.products.first} first_item{elseif $smarty.foreach.products.last} last_item{/if}" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
