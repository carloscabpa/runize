...
*}
{if $isDropdown}
	<div class="block block-categories hidden-sm-down">
		<h4 class="title_block"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Category' mod='smartblogpopularposts'}</a></h4>
		<select class="category-blog-dropdown" onchange="document.location.href=this.options[this.selectedIndex].value;">
...
{else}
	...
	<div class="block block-categories hidden-sm-down">
		<h4 class="title_block"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Category' mod='smartblogpopularposts'}</a></h4>
	  <ul class="category-blog list-unstyled">
