...
<nav class="pagination row no-flow justify-content-around">
  <div class="col col-xs-12 col-lg-6 col-md-12">
    ...
    <span class="showing">{l s='Showing %from%-%to% of %total% item(s)' d='Shop.Theme.Catalog' sprintf=['%from%' => $pagination.items_shown_from ,'%to%' => $pagination.items_shown_to, '%total%' => $pagination.total_items]}</span>
    {/block}
  </div>
  <div class="col col-xs-12 col-lg-6 col-md-12">
