        ...
        <div class="col-md-10 d-flex align-items-center justify-content-end">
          <div class="policy-header d-flex">
            <div class="policy-1 p-item d-flex align-items-center">
              ...
              <div class="text-p">
                <p>{l s='Free Delivery' d='Shop.Theme.Policyheader'}</p>
                <p>{l s='From $ 250' d='Shop.Theme.Policyheader'}</p>
              </div>
            </div>
            <div class="policy-2 p-item d-flex align-items-center">
              <div class="icon-p"></div>
              <div class="text-p">
                <p>{l s='Money back' d='Shop.Theme.Policyheader'}</p>
                <p>{l s='GUARANTEED' d='Shop.Theme.Policyheader'}</p>
              </div>
            </div>
            <div class="policy-3 p-item d-flex align-items-center">
              <div class="icon-p"></div>
              <div class="text-p">
                <p>{l s='cash on delivery' d='Shop.Theme.Policyheader'}</p>
                <p>{l s='From $ 50' d='Shop.Theme.Policyheader'}</p>
              </div>
            </div>
          </div>
...
<div class="header-color-2 hidden-sm-down">
  <div class="container">
   <div class="header-bottom d-flex align-items-center">
      ...
      <div id="_desktop_top_menu">{hook h="displayMegamenu" menu_type="horizontal"}</div>
      </div>
