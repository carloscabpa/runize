...
{block name='header_top'}
    <div class="header-top hidden-sm-down header-color-1 pt-50 pb-15">
        <div class="container">
            <div class="row align-items-center no-gutters">
                <div id="_desktop_logo" class="contentsticky_logo col-md-2 col-lg-2">
                ...
                <div class="col-md-7 col-lg-8 position-static">
                    <div id="_desktop_top_menu" class="contentsticky_menu">
                        {hook h="displayMegamenu" menu_type="horizontal"}
                    </div>
                </div>
                <div class="col-md-3 col-lg-2 d-flex align-items-center justify-content-end header-top-right">
                    <div id="_desktop_advancsearch" class="border-0 bg-transparent">
    ...
    <div id="header-sticky">
        <div class="container">
            <div class="row align-items-center">
                <div class="contentstickynew_logo col-lg-2"></div>
                <div class="contentstickynew_menu col-lg-8 position-static"></div>
